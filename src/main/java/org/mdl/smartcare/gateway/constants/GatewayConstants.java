...
public final class GatewayConstants {
    ...
    public static final class Keycloak {
        ...
        public static final String ENDPOINT_TOKEN_INTROSPECT = "/protocol/openid-connect/token/introspect";
    ...
    public static final class LogMessages {
        ...
        public static final String AUTH_NO_PERMISSIONS = "Authorization failed: No permissions found for request {} {}";
        public static final String AUTH_NO_MAPPINGS = "Authorization failed: No permission mappings configured";
        public static final String AUTH_GRANTED = "Authorization granted: Permission '{}' allows {} {}";
        public static final String AUTH_DENIED = "Authorization denied: No matching permission found for {} {} with permissions {}";
        
        public static final String LOADING_PERMISSIONS = "Loading permissions from database...";
        public static final String PERMISSIONS_LOADED = "Successfully loaded {} permissions from database covering {} unique permission names";
        public static final String NO_PERMISSIONS_IN_DB = "No permissions found in database. Using YAML configuration as fallback.";
        
        public static final String KEYCLOAK_CLIENT_CREATED = "Successfully created Keycloak client with custom Jackson configuration";
        public static final String KEYCLOAK_CLIENT_FAILED = "Failed to create Keycloak client. Server: {}, Realm: {}";
        ...
        public static final String KEYCLOAK_ROLE_EXISTS = "Keycloak role already exists with same description: {}";
        public static final String KEYCLOAK_ROLE_DELETED = "Deleted Keycloak role (not in database): {}";
        public static final String KEYCLOAK_ROLE_DELETE_FAILED = "Failed to delete Keycloak role: {}. Error: {}";
        public static final String KEYCLOAK_SYNC_COMPLETED = "Keycloak sync completed. Success: {}, Failed: {}";
    }
}
